				 ...
				 SoupBuffer *buffer, GHashTable **params)
{
	...
	if ((content_type != NULL) &&
	    (!g_ascii_strcasecmp (content_type, "text/plain") ||
	     !g_ascii_strcasecmp (content_type, "text/plain; charset=ISO-8859-1") ||
	     !g_ascii_strcasecmp (content_type, "text/plain; charset=iso-8859-1") ||
	     !g_ascii_strcasecmp (content_type, "text/plain; charset=UTF-8")))
